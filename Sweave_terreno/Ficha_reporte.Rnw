...
\textbf{Kilometraje: } \Sexpr{ifelse(hoja_c[6,5] == 'No Aplica','No aplica',ifelse(is.na(hoja_c[6,3]),'nd',paste0(as.numeric(hoja_c[6,3]),' (',hoja_c[6,5],')')))}\\
